...
struct Alerter {
    ...
    static func giveAlertForJournal(withTitle title:String, withMessage message:String, fromViewController viewController:UIViewController, andContext context:NSManagedObjectContext, andWorkout workout:Workout) {
        let alertController = UIAlertController(title: title, message: message, preferredStyle: .alert)
